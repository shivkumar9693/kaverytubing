  ...
  return (
    <div className="min-h-screen pt-28 pb-20 relative overflow-hidden bg-[#0A1628]">
      ...
      <motion.div
        ...
        className="absolute top-[-100px] right-[-120px] w-[500px] h-[500px] rounded-full bg-[#F97316] blur-[140px] pointer-events-none"
      />
      <motion.div
        animate={{ scale: [1, 1.15, 1], opacity: [0.08, 0.15, 0.08] }}
        transition={{ duration: 10, repeat: Infinity, ease: 'easeInOut', delay: 3 }}
        className="absolute bottom-[-80px] left-[-100px] w-[450px] h-[450px] rounded-full bg-[#1E40AF] blur-[120px] pointer-events-none"
      />
      <motion.div
