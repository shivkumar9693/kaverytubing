  ...
  return (
    <div className="min-h-screen pt-28 pb-20 relative overflow-hidden bg-[#050505]">
      ...
      <motion.div
        ...
        className="absolute top-[-100px] right-[-120px] w-[500px] h-[500px] rounded-full bg-[#EF4444] blur-[140px] pointer-events-none"
      />
      <motion.div
        animate={{ scale: [1, 1.15, 1], opacity: [0.08, 0.15, 0.08] }}
        transition={{ duration: 10, repeat: Infinity, ease: 'easeInOut', delay: 3 }}
        className="absolute bottom-[-80px] left-[-100px] w-[450px] h-[450px] rounded-full bg-gray-600 blur-[120px] pointer-events-none"
      />
      <motion.div
        ...
        >
          ...
          <div className="mb-12 pb-8 border-b border-white/10 relative">
            ...
            <h1 className="text-4xl md:text-6xl font-black italic leading-tight uppercase tracking-tighter">
              Terms Of <span className="text-[#EF4444]">Service</span>
            </h1>
            <p className="mt-4 text-gray-400 font-medium italic">Kavery Tubing Solutions Pvt. Ltd. — Governing all transactions</p>
          </div>
            ...
            {[
              {
                ...
                body: 'All stainless steel pipes, tubes, and fittings are manufactured as per the technical specifications provided at the time of order. Clients are responsible for ensuring the selected dimensions and grades are suitable for their specific industrial applications.'
              },
              {
                number: '02',
              ...
              },
              {
                ...
                body: 'We provide a standard quality warranty against manufacturing defects for all our products. Third-party inspections are welcome and must be coordinated prior to factory dispatch.'
              },
              {
                number: '04',
                title: 'Industrial Compliance',
                body: 'Users of this website agree to use the technical information provided for lawful business inquiries only. Unauthorized reproduction of technical catalogs or site content is strictly prohibited.'
              }
            ].map((section, i) => (
              <motion.section
                key={i}
